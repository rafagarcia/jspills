...
const TableOfContents: FunctionalComponent<{ headings: MarkdownHeading[], langCode: LangCode }> = ({
	headings = [],
	langCode = '',
}) => {
	const itemOffsets = useRef<ItemOffsets[]>([]);
	const langCodeStr = langCode === 'es' ? 'En esta página' : 'On this page';
	...
	return (
		<>
			<h2 className="heading">{langCodeStr}</h2>
			<ul>
